...
public class FrmBookEva_ModifyEva extends JDialog implements ActionListener {
	...
	public FrmBookEva_ModifyEva(JDialog f, String s, boolean b,BeanBookEva eva) {
		super(f, s, b);
		this.eva=eva;
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				FrmBookEva_ModifyEva.this.eva=null;
			}
		});
	}
	@Override
