...
public class FrmBookStep_ModifyStep extends JDialog implements ActionListener {
	...
	private JLabel labelStepId = new JLabel("步骤编号：");
	private JLabel labelStepDes = new JLabel("步骤描述：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				...
				this.setVisible(false);
				JOptionPane.showMessageDialog(null,  "步骤修改完成","提示",JOptionPane.INFORMATION_MESSAGE);
