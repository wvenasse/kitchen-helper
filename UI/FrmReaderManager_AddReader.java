...
public class FrmReaderManager_AddReader extends JDialog implements ActionListener {
	...
	private JLabel labelReaderid = new JLabel("食材编号：");
	private JLabel labelReaderName = new JLabel("食材名称：");
	private JLabel labelReaderPrice = new JLabel("食材价格：");
	private JLabel labelReaderType = new JLabel("食材类别：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			int price=Integer.parseInt(this.edtPrice.getText());
			BeanReader r=new BeanReader();
			r.setReaderid(id);
			r.setReaderName(name);
			r.setReaderprice(price);
			r.setReaderstate("normal");
