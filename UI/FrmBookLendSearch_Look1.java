...
public class FrmBookLendSearch_Look1 extends JDialog implements ActionListener {
	...
	public FrmBookLendSearch_Look1(JDialog f, String s, boolean b,BeanBook book) {
		super(f, s, b);
		this.book=book;
