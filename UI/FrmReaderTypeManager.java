...
public class FrmReaderTypeManager extends JDialog implements ActionListener {
	...
	private Object tblTitle[]={"类别ID","类别名称","购买数量限制"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnAdd){
			FrmReaderTypeManager_AddReaderType dlg=new FrmReaderTypeManager_AddReaderType(this,"添加食材类别",true);
			dlg.setVisible(true);
			...
			FrmReaderTypeManager_ModifyReaderType dlg=new FrmReaderTypeManager_ModifyReaderType(this,"添加食材类别",true,readertype);
			dlg.setVisible(true);
			if(dlg.getReadertype()!=null){//刷新表格
				this.reloadTable();
			}
