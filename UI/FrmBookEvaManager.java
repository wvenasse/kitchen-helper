...
public class FrmBookEvaManager extends JDialog implements ActionListener {
	...
	public FrmBookEvaManager(JDialog f, String s, boolean b,BeanBook book) {
		super(f, s, b);
		this.book=book;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnAdd){
			String id=this.book.getBarcode();
			FrmBookEva_AddEva dlg=new FrmBookEva_AddEva(this,"添加评论",true,id);
			dlg.setVisible(true);
			...
			FrmBookEva_ModifyEva dlg=new FrmBookEva_ModifyEva(this,"修改评论信息",true,eva);
			dlg.setVisible(true);
			if(dlg.getBookEva()!=null){//刷新表格
				this.reloadTable();
			}
