...
public class FrmBookEva_AddEva1 extends JDialog implements ActionListener {
	...
	public FrmBookEva_AddEva1 (JDialog f, String s, boolean b,String id) {
		super(f, s, b);
		this.id=id;
		...
		this.edtuser.setText(SystemUserManager.currentUser.getUserid());
