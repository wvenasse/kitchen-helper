...
public class FrmLend_AddRecord extends JDialog implements ActionListener {
	...
	public FrmLend_AddRecord(JDialog f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			r.setLendOperUserid(id);
			r.setReaderid(name);
			r.setReadernumber(price);

			try {
				(new ReaderLendManager()).lend(r);
				this.record=r;
				this.setVisible(false);
