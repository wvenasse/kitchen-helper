...
public class FrmReaderManager extends JDialog implements ActionListener {
	...
	private Button btnStop = new Button("缺货");//挂失
	private Button btnReuse = new Button("有货");//解挂
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnAdd){
			FrmReaderManager_AddReader dlg=new FrmReaderManager_AddReader(this,"添加食材",true,this.readerTypeMap_name);
			dlg.setVisible(true);
			...
			FrmReaderManager_ModifyReader dlg=new FrmReaderManager_ModifyReader(this,"修改食材",true,this.readerTypeMap_name,reader);
			dlg.setVisible(true);
			if(dlg.getReader()!=null){//刷新表格
				this.reloadTable();
			}
			...
			BeanReader reader=this.readers.get(i);
			if(JOptionPane.showConfirmDialog(this,"确定删除该食材吗？","确认",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
				try {
