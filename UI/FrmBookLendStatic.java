...
public class FrmBookLendStatic extends JDialog implements ActionListener {
	...
	public FrmBookLendStatic(FrmMain f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			if(this.cmbPub.getSelectedIndex()>=0){
				BeanPublisher p=this.pubMap_name.get(this.cmbPub.getSelectedItem().toString());//SystemUserManager.currentUser.getUsername()
